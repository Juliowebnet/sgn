...
import PhoneIconWhite from '../assets/phone-icon-white.svg'
            ...
            <footer className="v-home__footer">
                ...
                <div className="v-home__footer__info-container">
                    ...
                    <div className="v-home__footer__info-item">
                        <ReactSVG src={EmailIconWhite} className="v-home__footer__icon"/>
                        <p className="v-home__footer__info-text">info@sng.com.do</p>
                    </div>
                    <div className="v-home__footer__info-item">
                        <ReactSVG src={PhoneIconWhite} className="v-home__footer__icon"/>
